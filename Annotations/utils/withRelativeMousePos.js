  ...
  return function (DecoratedComponent) {
    var WithRelativeMousePos = function (_Component) {
      ...
      function WithRelativeMousePos() {
        ...
        return (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = { x: null, y: null }, _this.innerRef = function (el) {
          _this.container = el;
