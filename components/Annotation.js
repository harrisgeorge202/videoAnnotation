...
export default compose(isMouseHovering(), withRelativeMousePos())((_temp2 = _class = function (_Component) {
  ...
  function Annotation() {
    ...
    return (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.setInnerRef = function (el) {
      _this.container = el;
  ...
  Annotation.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      props.annotations.map(function (annotation, i) {
